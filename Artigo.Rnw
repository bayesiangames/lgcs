...
<<echo=FALSE, warning=FALSE, results='markup', message=FALSE, highlight=TRUE, error=FALSE, fig.align='center', fig.show='hold', fig.pos='!h', fig.cap="Itinerários", fig.height=4, fig.width=4>>=


coordUFRGS <- geocode("UFRGS")
coordUFMS <- geocode("UFMS")
coordUnB <-  geocode("UnB")
coordAsuncion <-  geocode("Asuncion")


df <- data.frame(longitude = c(coordUFRGS[,1],
                               coordUnB[,1],
                               coordUFMS[,1],
                               coordAsuncion[,1],
                               coordUFRGS[,1]),
                 latitude =  c(coordUFRGS[,2],
                               coordUnB[,2],
                               coordUFMS[,2],
                               coordAsuncion[,2],
                               coordUFRGS[,2]))

map <- get_googlemap('Parana', 
                     markers = df, 
                     path = df, 
                     zoom = 5, 
                     maptype = c("roadmap"),
...
<<echo=TRUE, warning=FALSE, results='hide', message=FALSE, highlight=FALSE, error=FALSE, fig.show='hold', fig.align='center', fig.cap="Cálculo do valor de Shapley", fig.pos='h', fig.height=3, fig.width=6>>=
...
<<echo=FALSE, warning=FALSE, results='hide', message=FALSE, highlight=FALSE, error=FALSE, fig.show='hold', fig.align='center', fig.cap="Cálculo do valor de Shapley", fig.pos='h', fig.height=3, fig.width=6>>=
...
ggplot(data = valorShapley, 
       ...
       labs(title = "Resultado do cálculo do valor de Shapley", 
            x = "Nomes dos agenteslibrary(ggmap)", 
            y = "Valor de Shapley") +
