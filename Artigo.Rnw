...
\subsection{Conceitos sobre teoria dos jogos cooperativos}
...
ggmap(get_googlemap('Parana', 
                     ...
                     zoom = 5, 
                     maptype = c("roadmap"),
                     language = "pt-BR")) + labs(x = "Longitude", y = "Latitude") + 
                     annotate("text",
                              x = -55.6, 
                              y = -28.4,
                              label = "5", 
...
\subsubsection{Código em R}

<<echo=TRUE, warning=FALSE, results='hide', message=FALSE, highlight=FALSE, error=FALSE, fig.show='hide', background="gray95">>=
